...
Today I’m going to be talking mainly about the realization of preliminary product we’ve made and the academic and technical concerns that come with it. I’m not going to be interpreting it today, we simply cannot yet asses its value because we’ve not properly connected it to the academic discours yet. Contrary to most research, we do didn’t go in with a specific question. Instead We’ve taken a data-centered approach when making this. That’s what the first part of this presentation will be about the available data. Secondly I’ll discuss how the tool came to be. Then I’ll discuss the tool itself, it’s academical aspect and it’s technical aspect. To close the presentation off, I’ll show you a few feature’s which weren’t finished to show here today, and speculate a bit about where we plan to take this.
...
Besides that we plan to add additional features. Academically interesting is a feature we’re already well on our way of implementing. We’ve enumerated on the goods in the database and build a layer that can visualize basic Minard diagrams. It not even close to finished, but it already showing cool things. Things like evangelical goods to show the attempts at spreading religion, or the amount of military goods to show military capability. The trade of metals also shows interesting patterns. All of these could prove to be quite interesting if one is able to generate graphs and review them with a simple click. The latter will require one to be able to view the goods inside the visualization. Right now you get thrown to the BGB site if you click a ship.
